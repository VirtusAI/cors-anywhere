...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  ...
  // Strip response headers specified in options
  requestState.removeResponseHeaders.forEach(function(header) {
...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    removeResponseHeaders: [],      // Strip these response headers.
  ...
  return function(req, res) {
    req.corsAnywhereRequestState = {
      ...
      removeResponseHeaders: corsAnywhere.removeResponseHeaders,
    };
